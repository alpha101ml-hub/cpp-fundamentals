...
/**
Ask the user what grade they expect on an exam and tell them what they need to score to get that grade. 
*/
...
int main() {
    ...
    switch(letter_grade){
        ...
        case 'd':
        case 'D':
            cout<<"You need 60-69 for a D,you should strive for beter grade"<<endl;
            break;
        case 'f':
        case 'F':
            {
